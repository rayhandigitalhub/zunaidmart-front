...
export default async function ProductsPage({ searchParams }: { searchParams: { q?: string } }) {
      ...
      return e(Fragment, null, e(Header), e('main', { className: 'listing-page container' }, e('div', { className: 'breadcrumb' }, 'Home › ' + title), e('div', { className: 'listing-layout' }, e('aside', { className: 'filters' }, e('h3', null, 'Filters'), e('div', { className: 'filter-group' }, e('strong', null, 'Category'), label('Home & Living'), label('Fashion'), label('Electronics'), label('Beauty & Care')), e('div', { className: 'filter-group' }, e('strong', null, 'Price'), label('৳ ০–৫০০'), label('৳ ৫০০–১,০০০'), label('৳ ১,০০০+'))), e('section', { className: 'listing-content' }, e('div', { className: 'listing-top' }, e('div', null, e('p', { className: 'eyebrow orange' }, 'ZUNAID MART CATALOG'), e('h1', null, title), e('span', null, products.length + ' products found')), e('select', { 'aria-label': 'Sort' }, e('option', null, 'Sort: Popular'), e('option', null, 'Price: কম থেকে বেশি'), e('option', null, 'New arrivals'))), body))));
}
