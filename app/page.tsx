...
export default async function HomePage() {
  ...
  ), e('footer', { id: 'contact', className: 'site-footer' }, e('div', { className: 'container footer-shell' }, e('div', { className: 'footer-brand-block' }, e(Link, { href: '/', className: 'brand footer-brand' }, e('img', { src: 'https://zunaidmart.com/wp-content/uploads/2026/06/cropped-wp-site-logo.png', alt: 'ZunaidMart official logo', className: 'brand-logo' }), e('span', null, e('strong', null, 'ZUNAID'), e('small', null, 'MART'))), e('p', { className: 'footer-lead' }, 'Simple, trusted online shopping for Bangladesh.'), e('div', { className: 'footer-contact-card', id: 'delivery' }, e('strong', null, 'Need help?'), e('span', null, 'Call 01622 051017'), e('span', null, 'WhatsApp +880 1605 586089'), e('span', null, 'Delivery: Dhaka & nationwide · COD available'))), e('div', { className: 'footer-column' }, e('h3', null, 'Shop'), link('/products', 'All products'), link('/products?q=deal', "Today's deals"), link('/cart', 'Your cart')), e('div', { className: 'footer-column' }, e('h3', null, 'Support'), link('#contact', 'Contact us'), link('#delivery', 'COD & delivery'), link('/checkout', 'Checkout')), e('div', { className: 'footer-column' }, e('h3', null, 'Stay connected'), e('p', null, 'Official updates and product picks.'), e('span', { className: 'footer-social' }, 'Facebook · Instagram'))), e('div', { className: 'container footer-bottom' }, e('span', null, '© 2026 Zunaid Mart'), e('span', null, 'Source catalog: zunaidmart.com'))));
}
