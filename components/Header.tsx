...
export default function Header() {
  return e('header', { className: 'site-header' },
    ...
    e('div', { className: 'header-main container' }, brand(), e('form', { className: 'search-form', action: '/products' }, e('input', { name: 'q', placeholder: 'What are you looking for?', 'aria-label': 'Search products' }), e('button', { type: 'submit', 'aria-label': 'Search' }, '⌕')), e('div', { className: 'header-actions' }, link('/products', 'Wishlist', 'action-link'), link('/cart', 'Cart', 'action-link'))),
