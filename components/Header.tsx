...
export default function Header() {
        return e('header', { className: 'site-header' },
                     e('div', { className: 'top-strip' }, e('div', { className: 'container top-inner' }, e('span', null, 'বাংলাদেশজুড়ে সহজ অনলাইন শপিং'), e('nav', { 'aria-label': 'সাহায্য লিংক' }, link('/products', 'সব পণ্য'), link('#delivery', 'ডেলিভারি তথ্য'), link('#contact', 'যোগাযোগ')))),
                     ...
                     e('div', { className: 'category-nav' }, e('div', { className: 'container category-inner' }, link('/products', '☰ সব ক্যাটাগরি', 'category-all'), link('/products?q=নতুন', 'নতুন পণ্য'), link('/products?q=অফার', 'আজকের অফার'), link('/products?q=ঘর', 'ঘর ও জীবন'), link('/products?q=ফ্যাশন', 'ফ্যাশন'), link('/products?q=ইলেকট্রনিক্স', 'ইলেকট্রনিক্স'), e('span', { className: 'delivery-note' }, '🚚 দ্রুত ডেলিভারি · COD available')))
                   );
}
